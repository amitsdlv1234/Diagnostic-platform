...
import { packageCategories } from "../../../features/packages/packageData";

import type { PackageFilters as PackageFiltersType } from "../../../features/packages/packageUtils";
...
export function PackageFilters({
  ...
  const updateFilter = <
    K extends keyof PackageFiltersType,
  >(
    key: K,
    value: PackageFiltersType[K],
  ) => {
    onChange({
      ...filters,
      [key]: value,
